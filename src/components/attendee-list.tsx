    ...
    return (
      <div className="flex flex-col gap-4">
        <div className="flex gap-3 items-center">
          ...
          <div className="px-3 w-72 px-1.5 border border-white/10 rounded-lg flex items-center gap-3">
          ...
          <table className="w-full">
            ...
            <tbody>
              <tr className="border-b border-white/10 hover:bg-white/5">
                ...
                <td className="py-3 px-4 text-sm text-zinc-300">221193</td>
                <td className="py-3 px-4 text-sm text-zinc-300">
                  <div className="flex flex-col gap-1">
                    <span className="font-semibold text-white">Herick da Silva Moreira</span>
                    <span>Herick@email.com</span>
                  </div>
                </td>
            ...
            <tfoot>
              <tr>
                <td className="py-3 px-4 text-sm text-zinc-300" colSpan={3}>
                  Mostrando 10 de 942 itens
                </td>
                <td className="py-3 px-4 text-sm text-zinc-300 text-right" colSpan={3}>
                  <div className="inline-flex items-center gap-8">

                    <span>Página 1 de 95</span>
